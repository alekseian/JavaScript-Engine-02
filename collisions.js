...
export class Collisions {
    ...
    detectCollisionPolygonPolygon(o1, o2) {
        ...
        const vector1to2 = o2.shape.position.clone().subtract(o1.shape.position) //helps us find vector between two
        ...
        //check of axes are not on the back side of the rectangle 
